...
function Word({
    ...
    return (
        ...
        >
            ...
            ) : aiSearchingIcon || bibleIcon || championIcon || signature || codeIcon || friendEmoji || globeIcon || heroIcon || ideaIcon || laughEmoji || loveIcon || movieIcon || nerdEmoji || plantIcon || pointingEmoji || teacherIcon || tennisBallIcon ? (
                <>
