...
export function MapWidget({ widget }: MapWidgetProps) {
    ...
    return (
        ...
        >
            <iframe
                className="pointer-events-none absolute -inset-x-4 -inset-y-10 z-1 h-[calc(100%+5rem)] w-[calc(100%+2rem)] border-0 [filter:grayscale(0.15)_saturate(0.72)_contrast(0.92)_brightness(1.06)]"
                src={mapUrl}
